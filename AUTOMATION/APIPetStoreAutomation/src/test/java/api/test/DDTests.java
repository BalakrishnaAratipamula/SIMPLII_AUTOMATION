...
public class DDTests {
	...
	public void testPostUser(String UserID, String UserName, String FirstName, 
		...
		User userPayload = new User();	//POJO class
	...
	@Test(priority=3, dataProvider="UserNames", dataProviderClass=DataProviders.class)  //(priority, 'UserNames' specified as Dataprovider name in DataProviders class, DataProvider class name)
