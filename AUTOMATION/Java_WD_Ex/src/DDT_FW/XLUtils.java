...
public static String getCellData(String xlfile,String xlsheet,int rownum,int colnum) throws Exception{
		...
		try {
			...
			data=""; //to print cell data is null error msg 
		}
		wb.close();
		fi.close();
		return data;
...
public static void setCellData(String xlfile,String xlsheet,int rownum,int colnum,String data) throws Exception{
		...
		wb.write(fo);	//to write stream of characters in outputFile	
		wb.close();
		fi.close();
		fo.close();
}
...
public static void main(String[] args) throws Exception {
	...
	String path = "F:\\DDF_Mercury login data.xlsx";    // F:\mercury login data.xlsx
	XLUtils.setExcelFile(path, "Sheet1"); //XLUtils --- class 
