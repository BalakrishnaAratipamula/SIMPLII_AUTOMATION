...
public class UserDefinedException2 extends Exception { // Exception class internally extends Throwable class
	...
	public static void withdraw(int amount) throws UserDefinedException2 {
		if (amount > 2000) {
			...
			throw new UserDefinedException2("***User Defined msg: You dont have sufficient amount to withdraw***");
