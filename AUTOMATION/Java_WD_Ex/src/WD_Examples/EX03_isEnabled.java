...
public class EX03_isEnabled {
	public static void main(String[] args) throws Exception {
		...
		WebElement ele = driver.findElement(By.xpath("/html[position()=1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/form[1]/div[5]/a[1]"));
		...
		//to click on Sign-up
		if(ele.isEnabled()==true) {   //(or) refobj.isEnabled()
