...
public class EX33b_Handling_MultipleWindows_M2b_Iterate_IfDontKnow_TheWindowCount {
	public static void main(String[] args) throws InterruptedException {
		...
		// Using Iterator to iterate with in windows (If we don't know the number of iterations)
